...
<body>
	...
	<div id="register" class="wrap">
		<div class="shadow">
			...
			<div class="box">
				<h1 style="background:#1874CD">学生注册</h1>
				<table style="margin-left: 150px">
					...
					<tr>
						...
						<td><label class="ui-green" style="margin-left: 10px"><input
								type="button" id="btnReg" value="立即登录" style="background:#1874CD" /></label>&nbsp;&nbsp;<font
							id="error" color="red">${error }</font></td>
					</tr>
				</table>
				<a href="AdminLogin.jsp" style="margin-left: 200px">管理员登入</a> 
				<a href="../student/login.jsp" style="margin-left: 50px">学生登入</a>
			</div>
		</div>
		<div class="clear"></div>
	</div>
