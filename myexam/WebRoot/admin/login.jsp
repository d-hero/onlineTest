			...
			if ($("#Stuno").val() == "") {
				...
				$.post("${pageContext.request.contextPath}/Students/selectAll1", {
					...
					if (data) {
							...
							location.href = "${pageContext.request.contextPath}/Students/login?stuno="+$("#Stuno").val(); 
...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1 style="background:#fc7e31">学生登陆</h1>
			<form id="loginForm" >
				<table style="margin-left: 50px">
					<tr>
						<td class="field">用户名：</td>
						<td><input class="text" type="text"  id="Stuno"   /><span></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><label class="ui-green" style="margin-left: 50px"><input type="button" id="btnReg" value="立即登录" style="background:#fc7e31"/></label>&nbsp;&nbsp;<font id="error"  color="red">${error }</font></td>
					</tr>
				</table>
				<a href="admin/AdminLogin.jsp" style="margin-left: 200px">管理员登入</a>
				<a href="register.jsp" style="margin-left: 100px">学生注册</a>
			</form>
		</div>
	</div>
	<div class="clear"></div>
