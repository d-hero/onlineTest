						...
						<c:choose>
							<c:when test="${!empty sessionScope.stu }">
								<div id="login-info-user">								
									<span class="btn btn-primary">欢迎你|${stu.stuname}</span>
			...
			<div class="container">
				<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
					<ul class="nav navbar-nav">
						<li class="active">
							<a href="student/index.jsp"><i class="fa fa-home"></i>首页</a>
						</li>
						<li>
							<a href="student/exatype.jsp"><i class="fa fa-edit"></i>试题练习</a>
						</li>
						<li>
							<a href="javascript:goResult()"><i class="fa fa-dashboard"></i>试卷管理</a>
						</li>
						<li>
					...
					<div class="row">
						<div class="select-test col-xs-6">
							<div style="height: 100px;">
								...
								<div class="select-test-content">
									...
									<a  href="student/addQuestion.jsp" class="btn btn-primary"><i class="fa fa-arrow-right"></i>参加练习</a>
								</div>
								<!--//content-->
							</div>
						</div>
						...
						<div class="select-test col-xs-6">
							<div style="height: 100px;">
								...
								<div class="select-test-content">
									<h3 class="title">正式考试</h3>
									<p>
										根据最新大纲的考查要求为你自动生成的模拟卷
									</p>
									<a  href="student/exatype.jsp" class="btn btn-primary" ><i class="fa fa-arrow-right"></i>参加测验</a>								
								</div>
								<!--//content-->
							</div>
						</div>
